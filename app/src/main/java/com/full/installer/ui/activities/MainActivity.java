...
import static com.full.installer.fileoperations.filesystem.FolderStateKt.WRITABLE_OR_ON_SDCARD;
import static com.full.installer.fileoperations.filesystem.OperationTypeKt.COMPRESS;
import static com.full.installer.fileoperations.filesystem.OperationTypeKt.COPY;
import static com.full.installer.fileoperations.filesystem.OperationTypeKt.DELETE;
import static com.full.installer.fileoperations.filesystem.OperationTypeKt.EXTRACT;
import static com.full.installer.fileoperations.filesystem.OperationTypeKt.MOVE;
import static com.full.installer.fileoperations.filesystem.OperationTypeKt.NEW_FILE;
import static com.full.installer.fileoperations.filesystem.OperationTypeKt.NEW_FOLDER;
import static com.full.installer.fileoperations.filesystem.OperationTypeKt.RENAME;
import static com.full.installer.fileoperations.filesystem.OperationTypeKt.SAVE_FILE;
import static com.full.installer.fileoperations.filesystem.OperationTypeKt.UNDEFINED;
import static com.full.installer.ui.dialogs.SftpConnectDialog.ARG_ADDRESS;
import static com.full.installer.ui.dialogs.SftpConnectDialog.ARG_DEFAULT_PATH;
import static com.full.installer.ui.dialogs.SftpConnectDialog.ARG_EDIT;
import static com.full.installer.ui.dialogs.SftpConnectDialog.ARG_HAS_PASSWORD;
import static com.full.installer.ui.dialogs.SftpConnectDialog.ARG_KEYPAIR_NAME;
import static com.full.installer.ui.dialogs.SftpConnectDialog.ARG_NAME;
import static com.full.installer.ui.dialogs.SftpConnectDialog.ARG_PASSWORD;
import static com.full.installer.ui.dialogs.SftpConnectDialog.ARG_PORT;
import static com.full.installer.ui.dialogs.SftpConnectDialog.ARG_USERNAME;
import static com.full.installer.ui.fragments.FtpServerFragment.REQUEST_CODE_SAF_FTP;
import static com.full.installer.ui.fragments.preferencefragments.PreferencesConstants.PREFERENCE_BOOKMARKS_ADDED;
import static com.full.installer.ui.fragments.preferencefragments.PreferencesConstants.PREFERENCE_COLORED_NAVIGATION;
import static com.full.installer.ui.fragments.preferencefragments.PreferencesConstants.PREFERENCE_NEED_TO_SET_HOME;
import static com.full.installer.ui.fragments.preferencefragments.PreferencesConstants.PREFERENCE_VIEW;
...
import com.full.installer.LogHelper;
//import com.amaze.filemanager.R;
import com.full.installer.R;
import com.full.installer.adapters.data.StorageDirectoryParcelable;
import com.full.installer.application.AppConfig;
import com.full.installer.asynchronous.SaveOnDataUtilsChange;
import com.full.installer.asynchronous.asynctasks.CloudLoaderAsyncTask;
import com.full.installer.asynchronous.asynctasks.DeleteTask;
import com.full.installer.asynchronous.asynctasks.TaskKt;
import com.full.installer.asynchronous.asynctasks.movecopy.MoveFilesTask;
import com.full.installer.asynchronous.management.ServiceWatcherUtil;
import com.full.installer.asynchronous.services.CopyService;
import com.full.installer.database.CloudContract;
import com.full.installer.database.CloudHandler;
import com.full.installer.database.SortHandler;
import com.full.installer.database.TabHandler;
...
import com.full.installer.fileoperations.filesystem.StorageNaming;
import com.full.installer.fileoperations.filesystem.usb.SingletonUsbOtg;
import com.full.installer.fileoperations.filesystem.usb.UsbOtgRepresentation;
import com.full.installer.filesystem.ExternalSdCardOperation;
import com.full.installer.filesystem.FileUtil;
import com.full.installer.filesystem.HybridFile;
import com.full.installer.filesystem.HybridFileParcelable;
import com.full.installer.filesystem.MakeFileOperation;
import com.full.installer.filesystem.PasteHelper;
...
import com.full.installer.ui.ExtensionsKt;
import com.full.installer.ui.activities.superclasses.PermissionsActivity;
import com.full.installer.ui.dialogs.AlertDialog;
import com.full.installer.ui.dialogs.GeneralDialogCreation;
import com.full.installer.ui.dialogs.HiddenFilesDialog;
import com.full.installer.ui.dialogs.HistoryDialog;
import com.full.installer.ui.dialogs.RenameBookmark;
import com.full.installer.ui.dialogs.RenameBookmark.BookmarkCallback;
import com.full.installer.ui.dialogs.SftpConnectDialog;
import com.full.installer.ui.dialogs.SmbConnectDialog;
import com.full.installer.ui.dialogs.SmbConnectDialog.SmbConnectionListener;
import com.full.installer.ui.drag.TabFragmentBottomDragListener;
import com.full.installer.ui.fragments.AppsListFragment;
import com.full.installer.ui.fragments.CloudSheetFragment;
import com.full.installer.ui.fragments.CloudSheetFragment.CloudConnectionCallbacks;
import com.full.installer.ui.fragments.CompressedExplorerFragment;
import com.full.installer.ui.fragments.FtpServerFragment;
import com.full.installer.ui.fragments.MainFragment;
import com.full.installer.ui.fragments.ProcessViewerFragment;
import com.full.installer.ui.fragments.SearchWorkerFragment;
import com.full.installer.ui.fragments.TabFragment;
import com.full.installer.ui.fragments.preferencefragments.PreferencesConstants;
import com.full.installer.ui.strings.StorageNamingHelper;
import com.full.installer.ui.theme.AppTheme;
import com.full.installer.ui.views.CustomZoomFocusChange;
import com.full.installer.ui.views.appbar.AppBar;
import com.full.installer.ui.views.drawer.Drawer;
import com.full.installer.utils.AppConstants;
import com.full.installer.utils.BookSorter;
import com.full.installer.utils.DataUtils;
import com.full.installer.utils.MainActivityActionMode;
import com.full.installer.utils.MainActivityHelper;
import com.full.installer.utils.OTGUtil;
import com.full.installer.utils.PackageUtils;
import com.full.installer.utils.PreferenceUtils;
