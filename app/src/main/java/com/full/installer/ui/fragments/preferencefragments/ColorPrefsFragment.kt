...
import com.full.installer.adapters.ColorAdapter
import com.full.installer.application.AppConfig
import com.full.installer.databinding.DialogGridBinding
import com.full.installer.ui.colors.ColorPreference
import com.full.installer.ui.colors.UserColorPreferences
import com.full.installer.ui.dialogs.ColorPickerDialog
...
class ColorPrefsFragment : BasePrefsFragment() {
    ...
    private fun showColorChangeDialog(colorPrefKey: String) {
        ...
        dialog = MaterialDialog.Builder(activity)
            .positiveText(com.full.installer.R.string.cancel)
            .title(com.full.installer.R.string.choose_color)
            .theme(activity.appTheme.getMaterialDialogTheme(activity.applicationContext))
            .autoDismiss(true)
            .positiveColor(fabSkin)
            .neutralColor(fabSkin)
            .neutralText(com.full.installer.R.string.default_string)
            .onNeutral { _, _ ->
                activity
                    .colorPreference
