...
import com.full.installer.asynchronous.services.EncryptService
import com.full.installer.asynchronous.services.EncryptService.TAG_AESCRYPT
import com.full.installer.asynchronous.services.EncryptService.TAG_ENCRYPT_TARGET
import com.full.installer.asynchronous.services.EncryptService.TAG_PASSWORD
import com.full.installer.databinding.DialogEncryptAuthenticateBinding
import com.full.installer.filesystem.HybridFileParcelable
import com.full.installer.filesystem.files.CryptUtil.AESCRYPT_EXTENSION
import com.full.installer.filesystem.files.CryptUtil.CRYPT_EXTENSION
import com.full.installer.filesystem.files.EncryptDecryptUtils.EncryptButtonCallbackInterface
import com.full.installer.ui.activities.MainActivity
import com.full.installer.ui.fragments.preferencefragments.PreferencesConstants.PREFERENCE_CRYPT_WARNING_REMEMBER
import com.full.installer.ui.openKeyboard
...
import com.full.installer.ui.views.WarnableTextInputValidator.ReturnState
import com.full.installer.ui.views.WarnableTextInputValidator.ReturnState.STATE_ERROR
