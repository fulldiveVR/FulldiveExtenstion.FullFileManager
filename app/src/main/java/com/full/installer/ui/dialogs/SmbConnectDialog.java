...
import static com.full.installer.utils.SmbUtil.PARAM_DISABLE_IPC_SIGNING_CHECK;
...
import com.full.installer.filesystem.smb.CifsContexts;
...
import com.full.installer.utils.EditTextColorStateUtil;
import com.full.installer.utils.SimpleTextWatcher;
...
public class SmbConnectDialog extends DialogFragment {
  ...
  public interface SmbConnectionListener {
     ...
     *     now. See {@link com.full.installer.database.UtilsHandler#removeSmbPath(String,
     *     String)}
     */
